...
public class DownloadBookService extends Service {
    ...
    private int download(String url, final String bookId, final String title, final int chapter, final int chapterSize, final String bookName, final boolean isAppend) {
